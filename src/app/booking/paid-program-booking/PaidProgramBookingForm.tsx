        ...
        <div className={`space-y-6 ${isArabic ? 'text-right' : ''}`}>
          ...
          <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right flex-1 min-w-[250px] bg-white p-3 rounded-xl border border-indigo-100 shadow-sm">
                <PaymentBreakdown type={selectedProgramType} option={pendingPaymentOption} />
              </div>
            </div>
          </div>
