...
export default function MethodHero() {
  ...
  return (
    <section className="relative w-full bg-[#FAFBFF] py-6 md:py-8 lg:py-10">
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-5 sm:px-6 md:px-12">
        ...
        <div className="text-center mb-5 md:mb-6">
          ...
          >
            <h1 className="mb-2 text-[28px] md:text-[36px] lg:text-[48px] xl:text-[52px] font-medium leading-[1.4] tracking-tight text-[#0B1028]">
              {t.method.heading}
            </h1>
            <p className={`mb-4 text-[13px] md:text-[14px] lg:text-[15px] ${isUrdu ? 'leading-[2]' : 'leading-[1.8]'} text-[#64748B]`}>
              {t.method.subtitle}
            </p>
...
function PhaseCard({ phase, index }: { phase: any; index: number }) {
  return (
    ...
    >
      {/* Phase number */}
      <div className="flex h-10 w-10 items-center justify-center rounded-full border-[2px] border-[#E2E8F0] bg-white font-mono text-[13px] font-semibold text-[#64748B] shadow-sm mb-3 transition-colors duration-500 group-hover:border-[#6366F1] group-hover:text-[#6366F1]">
        0{index + 1}
      </div>
      ...
      <span className="inline-block rounded-md bg-[#F1F5F9] px-2 py-0.5 text-[11px] font-medium tracking-wide text-[#64748B] mb-2 italic">
        {phase.desc}
      </span>
