    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-[#111827] border border-white/5 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm text-gray-400">No-Show Rate</span>
          </div>
        ...
        <div className="bg-[#111827] border border-white/5 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm text-gray-400">Cancel Rate</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#111827] border border-white/5 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-5">
            <BarChart3 className="w-5 h-5 text-violet-400" />
            <h3 className="text-white font-semibold">Monthly Bookings</h3>
          </div>
          <div className="flex items-end gap-2 h-48">
            {data.monthlyBookings.map((item, i) => {
              ...
              return (
                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                  <span className="font-mono text-[10px] text-gray-400">{item.total}</span>
          ...
          <div className="flex items-center gap-4 mt-4 justify-center">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[11px] text-gray-400">No-Show</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[#111827] border border-white/5 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="text-white font-semibold">Assessment Trends</h3>
          </div>
            ...
            {data.assessmentTrends.map((item, i) => {
              ...
              return (
                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                  ...
                  <span className="text-[9px] text-gray-600">n={item.count}</span>
                </div>
              );
            })}
          </div>
        ...
        <div className="bg-[#111827] border border-white/5 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="text-white font-semibold">Country Distribution</h3>
          </div>
              ...
              return (
                <div key={i} className="space-y-1">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-mono text-sm text-gray-400">{item.count}</span>
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-[#111827] border border-white/5 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="text-white font-semibold">Booking Types</h3>
          </div>
        ...
        <div className="bg-[#111827] border border-white/5 rounded-xl p-5">
          <div className="flex items-center gap-2 mb-5">
            ...
            <h3 className="text-white font-semibold">Notification Stats</h3>
          </div>
          <div className="space-y-4">
            {[
            ...
            <div className="pt-2 border-t border-white/5">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-mono text-gray-300">{data.notificationStats.byEmail}</span>
              </div>
              <div className="flex justify-between text-sm mt-1">
                <span className="text-gray-400">WhatsApp</span>
                <span className="font-mono text-gray-300">{data.notificationStats.byWhatsApp}</span>
              </div>
            </div>
          </div>
        </div>
