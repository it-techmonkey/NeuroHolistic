...
export default function RetreatNewsletter() {
  ...
  return (
    <Section
      padding="xl"
      background="light"
      id="retreat-newsletter"
      className="scroll-mt-24"
    >
      <div className="max-w-2xl mx-auto text-center">
        <H2 className="text-neutral-900 mb-4">
          Stay Updated on Future Retreats
        </H2>
        <Body className="text-neutral-600 mb-8">
          Join our mailing list to receive announcements about upcoming
          retreats and immersive gatherings.
        </Body>
        <form
        ...
        >
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex-1">
              <label htmlFor="retreat-email" className="sr-only">
                Email
              </label>
              <input
                id="retreat-email"
