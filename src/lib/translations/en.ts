/**
 * English translations for the NeuroHolistic Institute website.
...
export const en = {
  ...
  navbar: {
    ...
    logins: "Logins",
    bookNow: "Book Now",
    beginYourReset: "Begin Your Reset",
    contact: "Contact",
  },
  ...
  footer: {
    description:
      "The Institute is dedicated to restoring systemic balance through applied neuroscience and human systems logic.",
    inquiry: "Inquiry // Facilitation",
    beginYourReset: "Begin Your Reset",
    index01: "Index // 01",
    registry02: "Registry // 02",
    contact03: "Contact // 03",
    home: "Home",
    ...
    applyToAcademy: "Apply to Academy",
    remoteGlobal: "Remote // Global",
    dubaiLondon: "Dubai // London",
    privacyProtocol: "Privacy Protocol",
    termsOfService: "Terms of Service",
    copyrightYear: "Board of Standards",
    regNumber: "Reg-88402",
  },
  ...
  // ── Method Phases ──
  method: {
    heading: "The NeuroHolistic Method™",
    subtitle: "A Five-Phase Architecture for Systemic Transformation",
  ...
  programs: {
    heading: "Programs",
    privateProgram: "Private Program",
    privateDescription:
    ...
    areas: [
      {
        title: "Health",
        description:
          "Restore balance in your body, release built-up tension, and experience a renewed sense of energy, ease, and physical well-being.",
      },
      {
        title: "Mind & Heart",
        description:
          "Quiet the noise, gain clarity, and feel lighter, free from emotional weight and mental loops that have been holding you back.",
      },
      {
        title: "Relationships",
        description:
          "Shift how you connect, communicate, and respond, creating more ease, depth, and harmony in how you relate to others.",
      },
      {
        title: "Potential",
        description:
          "Move beyond limitations, think with clarity, and step into a stronger, more expanded version of yourself and what you are capable of.",
      },
    ],
    explore: "Explore",
  },
  ...
  // ── Team ──
  team: {
    heading: "The NeuroHolistic Team",
    founder: "Founder",
  ...
  // ── Academy CTA ──
  academyCTA: {
    heading: "The NeuroHolistic Academy",
    becomeATherapist: "Become a Therapist",
  },

  // ── Research ──
  research: {
    heading: "Research & Systems Development",
    paragraph1:
  ...
  consultationForm: {
    ...
    useForDashboard: "You'll use this to access your dashboard",
    ...
    pleaseFillAll: "Please fill in all required fields including password",
    passwordMin8: "Password must be at least 8 characters",
    selectTherapistDate: "Please select a therapist, date, and time",
    accountCreatedFailed: "Failed to create account",
    bookingFailed: "Booking failed",
    somethingWrong: "Something went wrong. Please try again.",
    signInFailed: "Failed to sign in. Please try logging in manually.",
  },
  ...
  about: {
    ...
    yearsOfExploration: "Years of Exploration",
    ...
    naturalState: "Natural State of Being",
    naturalStateText: "From a young age, I believed in the power within us. I knew we create our own lives and I never let myself be limited by the beliefs of others. I was fortunate to grow up in a loving family that supported free thinking, which allowed me to preserve the natural way of my being.",
    naturalAccess: "Natural Access to Knowledge",
    naturalAccessText: "What I later learned felt like something I already understood. I experienced knowledge before learning it, and naturally acted upon it. This strengthened my belief that something very powerful is accessible within us. My childhood was joyful and I thought this was normal for everyone. I could not understand why people would say 'I cannot.'",
    learnOrRecycle: "Learn or Recycle",
    learnOrRecycleText1: "Life changed when my father passed away, but I kept moving forward. As a young woman, I achieved things that were difficult for others — with ease and an open heart. Yet, I had not yet learned what life was preparing to show me.",
    learnOrRecycleText2: "Then, within a few years, everything changed. I lost my country, my nieces, my mother, my older brother, and my younger brother — the last members of my family.",
    learnOrRecycleText3: "I found myself completely alone. That is when I understood the true meaning of 'I cannot.'",
    matterOfChoice: "It Is a Matter of Choice",
  ...
  // ── Contact Page ──
  contactPage: {
    connectWith: "Connect with the",
    neuroHolisticInstitute: "NeuroHolistic Institute",
    description: "For consultations, academy applications, and collaborations.",
    contactDetails: "Contact Details",
    emailLabel: "Email:",
    locations: "Locations: Dubai // London",
  },
  ...
  // ── Training Structure ──
  trainingStructure: {
    heading1: "NeuroHolistic Applied",
    heading2: "Psychology Mastery",
    subtitle: "An advanced professional training program that combines scientific foundations, practitioner formation, and supervised practice to prepare you for ethical, effective applied work.",
    modules: [
      { step: "01", label: "Theory", title: "Foundations of Human Change", description: "Neuroscience, psychology, and epigenetic mechanisms of perception, behavior, and transformation." },
      { step: "02", label: "Formation", title: "Practitioner Development", description: "Professional identity, ethics, communication, and responsibility in applied psychological work." },
      { step: "03", label: "Logic", title: "Applied Psychology Practice", description: "Observation, pattern recognition, and structured intervention logic for human systems." },
      { step: "04", label: "Mastery", title: "Method™ Application", description: "Learning the internal logic and ethical application of the five-phase NeuroHolistic protocol." },
    ],
  },

  // ── Professional Outcome ──
  professionalOutcome: {
    heading1: "Certified NeuroHolistic",
    heading2: "Applied Psychology",
    heading3: "Practitioner",
    mainDescription: "Graduates are prepared to operate within clinical, emotional regulation, and wellbeing contexts, applying the integrative logic of the NeuroHolistic Method™ with systemic precision.",
    note: "Maintenance of professional boundaries and ethical standards is a mandatory prerequisite for the active use of the designation.",
    practitionerTitle: "Practitioner Title",
    designation: "CNAP-P Designation",
    authoredBy: "Authored by",
    boardName: "The NeuroHolistic Institute Board of Standards",
  ...
  retreatHero: {
    ...
    title1: "Step out of routine.",
    title2: "Enter deep transformation.",
  ...
  researchPage: {
    ...
    areasOfInquiry2: "Inquiry",
    focusAreas: [
      { step: "01", label: "Biological", title: "Neuroscience of Transformation", description: "Exploring neural mechanisms involved in perception, emotional regulation, and adaptive change." },
      { step: "02", label: "Physiological", title: "Mind-Body Interaction", description: "Investigating the relationship between psychological states, physiological regulation, and wellbeing." },
    ...
    collaborationTitle2: "Collaboration",
    collaborationParagraph: "The Institute aims to collaborate with universities, researchers, and academic institutions interested in advancing interdisciplinary research on human transformation, applied psychology, and wellbeing.",
  ...
  methodPage: {
    ...
    visionParagraph3: "By bringing together insights from neuroscience, psychology, and systemic approaches to human development, the method offers a pathway that not only helps resolve inner struggles but also expands the individual's capacity for awareness, resilience, and conscious living.",
    scientificFoundationsTitle: "Scientific & Theoretical Foundations",
    scientificFoundationsParagraph1: "The NeuroHolistic Method™ is grounded in contemporary scientific understanding of how the human system regulates, adapts, and transforms. Its theoretical foundation integrates insights from neuroscience, psychoneuroimmunology, and epigenetic regulation to understand how thoughts, emotions, and physiological states interact to shape human experience.",
    scientificFoundationsParagraph2: "Central to the method is the principle of neuroplasticity, the brain's ability to reorganize neural pathways in response to experience and meaningful emotional activation. Research on predictive coding, interoception, and autonomic regulation shows that the brain continuously interprets internal and external signals, shaping perception, emotional responses, and behavior patterns.",
    scientificFoundationsParagraph3: "The NeuroHolistic Method™ works within this biological reality by activating neural and physiological processes that allow the system to reorganize itself. Through carefully structured therapeutic interaction, including sensory-evocative language, emotional processing, and relational resonance, new patterns of perception and regulation can emerge, supporting deep and lasting transformation.",
    scientificFoundationsParagraph4: "The method also considers emerging perspectives on human bioenergetic processes and systemic coherence, recognizing that human transformation occurs through the dynamic interaction of neural, biochemical, emotional, and energetic dimensions of the living system.",
    scientificPillars: [
      "Positive Psychology",
    ...
    fivePhaseTitle: "The Five-Phase Architecture",
    fivePhaseSubtitle: "A systematic framework designed to facilitate lasting human change through neural and systemic reorganization.",
    phases: [
      { number: "01", title: "Release", desc: "Discharging the Symptoms. Releasing accumulated emotional charge from the body to restore nervous system balance." },
      { number: "02", title: "Subconscious Liberation", desc: "Removing the Root Cause. Dissolving the subconscious patterns and programming which created the symptoms." },
      { number: "03", title: "Neural Expansion", desc: "Breaking the loop. Freeing and expanding neural pathways to move beyond fixed responses and limitations." },
      { number: "04", title: "Targeted Transformation", desc: "Creating the new state. Designing and reinforcing neural pathways aligned with the desired state and identity." },
      { number: "05", title: "Integration & Stabilization", desc: "Stabilizing the transformation. Anchoring the transformation into a stable, embodied way of being." },
    ],
    beginConsultation: "Begin Your Consultation",
    beginConsultationDesc: "Work with specialized practitioners trained to guide you through the NeuroHolistic framework.",
    differenceTitle: "What Makes The Method Different",
    differenceParagraph1: "While many approaches focus on managing symptoms or addressing isolated aspects of human experience, the NeuroHolistic Method™ works with the human system as an integrated whole.",
    ...
    differenceParagraph3: "Unlike linear therapeutic models, the method follows a structured five-phase architecture that gradually restores internal coherence. Each phase prepares the system for the next, allowing emotional release, cognitive restructuring, and behavioral change to unfold in a stable and integrative way.",
    differenceParagraph4: "Another distinguishing aspect of the NeuroHolistic Method™ is its emphasis on systemic coherence. Rather than focusing only on individual thoughts or behaviors, the method addresses the dynamic relationship between the brain, body, emotional memory, and internal awareness. When these systems begin to realign, many aspects of life naturally begin to change.",
    differenceParagraph5: "As a result, the work often extends beyond resolving specific challenges. Individuals frequently experience broader shifts in clarity, resilience, relationships, and their capacity to engage with life more consciously and intentionally.",
    ...
    transformationAreasTitle: "Areas of Transformation",
    transformationAreasSubtitle: "When internal systems return to balance and coherence, change appears across multiple dimensions of life, altering how we think, feel, and engage with the world.",
    transformationAreas: [
      { title: "Health", description: "As the body moves out of chronic stress patterns, many individuals experience improvements in sleep, energy, and overall physical well-being. The nervous system regains its natural capacity for regulation, recovery, and resilience." },
      { title: "Mind", description: "With new neural pathways forming, mental clarity increases and emotional reactivity begins to soften. Patterns of anxiety, overthinking, or inner tension gradually give way to greater stability, awareness, and cognitive flexibility." },
      { title: "Relationships", description: "As internal balance grows, relational patterns often shift as well. Communication becomes clearer, boundaries healthier, and connections with others more authentic and supportive." },
      { title: "Human Potential", description: "When energy is no longer consumed by unresolved internal conflict, it becomes available for creativity, purpose, and meaningful engagement with life. Many individuals rediscover a deeper sense of direction and the confidence to pursue what truly matters." },
    ],
    explore: "Explore",
  ...
  resourcesPage: {
    eyebrow: "Resources",
    title1: "Explore practical",
    title2: "learning resources.",
    ...
    articlesDesc: "Foundational reading on regulation, perception, emotional patterns, and transformation.",
    mediaTitle: "Media & Videos",
    mediaDesc: "Curated interviews, educational clips, and practical guidance from the NeuroHolistic ecosystem.",
    audioTitle: "Audios",
    audioDesc: "Practical worksheets and reflection tools to support integration between sessions.",
  },

  // ── Team Page ──
  teamPage: {
    eyebrow: "",
    title: "The NeuroHolistic Team",
